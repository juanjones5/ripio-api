...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ing2 = sample_ingredient(user=self.user, name='Sugar')
        payload = {
            'title': 'Apple pie',
...
class RecipeImageUploadsTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Pad Thai')
        recipe2 = sample_recipe(user=self.user, title='Tacos')
        tag1 = sample_tag(user=self.user, name='Vegan')
        tag2 = sample_tag(user=self.user, name='GF')
